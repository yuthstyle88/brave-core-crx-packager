...
const regionalCatalogComponentId = 'lkefaodkjpifgihcafjhgdcaedpgbpeh'
...
const regionalCatalogPubkey = (privateKeyFile = 'out-all-pem/lkefaodkjpifgihcafjhgdcaedpgbpeh.pem') => {
  const [publicKey] = ntpUtil.generatePublicKeyAndID(privateKeyFile)
  return publicKey
}

const resourcesComponentId = 'pkkklfleebanfkkhgflegchobkgobhmi'
...
const resourcesPubkey = (privateKeyFile = 'out-all-pem/pkkklfleebanfkkhgflegchobkgobhmi.pem') => {
  const [publicKey] = ntpUtil.generatePublicKeyAndID(privateKeyFile)
  return publicKey
}
