...
const regionalCatalogPubkey = (privateKeyFile = 'out-ad-block-updater-pem/ad-block-updater-gkboaolpopklhgplhaaiboijnklogmbc.pem') => {
...
const resourcesPubkey = (privateKeyFile = 'out-ad-block-updater-pem/ad-block-updater-mfddibmblmbccpadfndgakiopmmhebop.pem') => {
  const [publicKey] = ntpUtil.generatePublicKeyAndID(privateKeyFile)
  return publicKey
}
